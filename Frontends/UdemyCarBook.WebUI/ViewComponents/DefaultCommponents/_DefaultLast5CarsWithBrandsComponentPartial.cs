...
namespace UdemyCarBook.WebUI.ViewComponents.DefaultCommponents
{
    public class _DefaultLast5CarsWithBrandsComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7173/api/Cars/GetLast5CarsWithBrandQueryHandler");
